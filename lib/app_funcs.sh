...
function write_profile_d_script() {
  ...
  local export_line="export PATH=\$HOME/.platform_tools:\$HOME/.platform_tools/erlang/bin:\$HOME/.platform_tools/elixir/bin:\$HOME/.platform_tools/node/node/bin:\$HOME/.platform_tools/phantomjs/phantomjs/bin:\$PATH
...
function write_export() {
  ...
  local export_line="export PATH=$(platform_tools_path):$(erlang_path)/bin:$(elixir_path)/bin:\$HOME/.platform_tools/node/node/bin:\$HOME/.platform_tools/phantomjs/phantomjs/bin:\$PATH
                     export LC_CTYPE=en_US.utf8"
